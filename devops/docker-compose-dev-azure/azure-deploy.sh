...
resourcename="01jcfft75fxnwf2g23cv2hc5qp"  # lower case, only
resourcegroup="01jcfft75fxnwf2g23cv2hc5qp_rg"
...
# git clone https://github.com/apilogicserver/01jcfft75fxnwf2g23cv2hc5qp.git
# cd 01jcfft75fxnwf2g23cv2hc5qp
...
az group create --name 01jcfft75fxnwf2g23cv2hc5qp_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group 01jcfft75fxnwf2g23cv2hc5qp_rg --sku S1 --is-linux
az container create --resource-group 01jcfft75fxnwf2g23cv2hc5qp_rg --name 01jcfft75fxnwf2g23cv2hc5qp --image apilogicserver/01jcfft75fxnwf2g23cv2hc5qp:latest --dns-name-label 01jcfft75fxnwf2g23cv2hc5qp --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//01jcfft75fxnwf2g23cv2hc5qp.westus.azurecontainer.io:5656'
