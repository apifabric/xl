...
@Component({
  selector: 'ScorekaartKandidaat-home',
  templateUrl: './ScorekaartKandidaat-home.component.html',
  styleUrls: ['./ScorekaartKandidaat-home.component.scss']
})
export class ScorekaartKandidaatHomeComponent implements AfterViewInit {
